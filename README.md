...
<p align="center">
  <img src="docs/preview-foil.png" width="45%" alt="金箔扫光：金线被反射光带扫过时的高光瞬间" />
  <img src="docs/preview-glow.png" width="45%" alt="线条辉光：线稿发光并向卡外溢出 Fog Glow" />
</p>

<p align="center">
  <sub>同一张卡的两个瞬间 —— 左边是金箔扫光掠过，右边是线条辉光拉满、光溢出卡外 ✨</sub>
</p>
...
- 合成里加了一层 Fog Glow，辉光能溢出卡外（就是开头右边那张的效果）
